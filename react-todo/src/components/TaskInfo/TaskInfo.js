...
const TaskInfo = (props) => {
    ...
    const [newTask, setNewTask] = useState({ id: "", name: "", description: "", date: "", priority: "Normal", viewing: false });
          ...
          <div className="inline">
              <div>
                  <label htmlFor="date">Due Date</label>
                    <input type="date" id="date" name="date" className="max-width" value={currentTask ? currentTask.date : newTask.date} onChange={handleChange} required/>
              </div>
              <div>
